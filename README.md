...
- [x] ~~Rotate compromised `ARK_API_KEY` in BytePlus console~~ — rotated 2026-07-23; old `…-bf689` key replaced in `.env`. Delete the old key in the BytePlus console if not already done.
